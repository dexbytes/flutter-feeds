...
class ErrorAlert{
  ErrorAlert({Key key,@required BuildContext context,String alertTitle,bool isItForInternet,@required message,@required callBackYes}){
            ...
            content:GestureDetector(
              ...
              child:  Container(
                ...
                child:ListView(
                  ...
                  children: [
                    Padding(
                        padding: EdgeInsets.only(top: AppDimens().verticalMarginPadding(value: 40),
                        ...
                        child:Align(
                          ...
                          child:  SvgPicture.asset(
                              ...
                              height:AppDimens().widthDynamic(value: 87),fit: BoxFit.scaleDown),
                        )
                    ),
                    Padding(
                        padding: EdgeInsets.only(top: AppDimens().verticalMarginPadding(value: 25),
                            ...
                            bottom: AppDimens().verticalMarginPadding(value: 40)),
                        child:Align(
                            alignment: Alignment.center,
                            child: Text(
                              msg??"",
