...
const baseUrlDevSportradarC = 'http://api.sportradar.com/tennis'; // Production API's
const baseUrlProdSportradarC = 'http://api.sportradar.com/tennis'; // Production API's
...
class ConstantC {
  ...
  static String awsS3EndpointDev =
  ...
  static String awsSecretKeyIdPro = '4mcLOf+SUMOzSXQiXgdfgdsfgajXB772evB+YSCe365/uzLo';
