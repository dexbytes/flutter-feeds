...
class ApiRequestMain {
  ...
  Future<Response> apiRequestPost(
    ...
    if (isInternetConnected != null && isInternetConnected.status) {
      ...
      projectUtil.printP(AppString(context).noInternetConnection);
      Response mResponse = new Response(
          false, AppString(context).noInternetConnection, -1000, null);
      return mResponse;
    }
  }
  ...
  Future<Response> apiRequestPost1(String url, bodyData, bool isLoader) async {
    ...
    if (isInternetConnected != null && isInternetConnected.status) {
      ...
      projectUtil.printP(" AppString(context).noInternetConnection");
      Response mResponse = new Response(
          false, AppString(context).noInternetConnection, -2000, null);
      return mResponse;
    }
  }
  ...
  Future<StreamedResponse> apiRequestMultipartAuthorizeWithBodyData(
    ...
    if (isInternetConnected != null && isInternetConnected.status) {
      ...
      projectUtil.printP(AppString(context).noInternetConnection);
      // Response mResponse = new Response(false,  AppString(context).noInternetConnection, -2000, null);
      return null;
    }
  }
  ...
  Future<StreamedResponse> apiRequestMultipartAuthorizeWithoutBodyData(
    ...
    if (isInternetConnected != null && isInternetConnected.status) {
      ...
      print(AppString(context).noInternetConnection);
      return null;
    }
  }
